...
from module import DropPath, to_2tuple, trunc_normal_, MHA, CSRA
...
class VIT_CSRA(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=47, embed_dim=768, depth=12,
                 num_heads=12, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, cls_num_heads=1, lam=0.3):
        super().__init__()
        self.add_w = 0.
        ...
        self.classifier = MHA(input_dim=embed_dim, num_heads=cls_num_heads, num_classes=num_classes, lam=lam)
