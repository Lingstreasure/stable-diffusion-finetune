...
class ResnetCsra(ResNet):
    ...
    def __init__(self, 
        ...
        self.init_weights(pretrained=False, cutmix=cutmix, load_path=load_path)
    ...
    def init_weights(self, pretrained=True, cutmix=None, load_path=None):
        if cutmix is not None:
            print("backbone params inited by CutMix pretrained model")
            state_dict = torch.load(cutmix)
        elif load_path:
            print("backbone params inited by trained model")
